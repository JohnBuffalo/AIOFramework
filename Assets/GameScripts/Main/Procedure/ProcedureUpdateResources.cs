...
{
    internal class UpdateLengthData
    {
    ...
    public class ProcedureUpdateResources : AIOFramework.ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            Entrance.Event.Subscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            Entrance.Event.Subscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            Entrance.Event.Subscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            Entrance.Event.Subscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
        ...
        protected override void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
            ...
            Entrance.Event.Unsubscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            Entrance.Event.Unsubscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            Entrance.Event.Unsubscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            Entrance.Event.Unsubscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
        ...
        private void StartUpdateResources(object userData)
        {
            ...
            Entrance.Resource.UpdateResources(OnUpdateResourcesComplete);
        }
        ...
        private void RefreshProgress()
        {
            ...
            string descriptionText = Entrance.Localization.GetString("UpdateResource.Tips",
                ...
                progressTotal, GetByteLengthString((int)Entrance.Download.CurrentSpeed));
