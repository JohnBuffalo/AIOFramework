...
{
    public class ProcedureVerifyResources : AIOFramework.ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            Entrance.Event.Subscribe(ResourceVerifyStartEventArgs.EventId, OnResourceVerifyStart);
            Entrance.Event.Subscribe(ResourceVerifySuccessEventArgs.EventId, OnResourceVerifySuccess);
            Entrance.Event.Subscribe(ResourceVerifyFailureEventArgs.EventId, OnResourceVerifyFailure);

            m_VerifyResourcesComplete = false;
            Entrance.Resource.VerifyResources(OnVerifyResourcesComplete);
        }
        ...
        protected override void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
            ...
            Entrance.Event.Unsubscribe(ResourceVerifyStartEventArgs.EventId, OnResourceVerifyStart);
            Entrance.Event.Unsubscribe(ResourceVerifySuccessEventArgs.EventId, OnResourceVerifySuccess);
            Entrance.Event.Unsubscribe(ResourceVerifyFailureEventArgs.EventId, OnResourceVerifyFailure);
        }
        ...
        private void OnResourceVerifyStart(object sender, GameEventArgs e)
        {
            ...
            Log.Info("Start verify resources, verify resource count '{0}', verify resource total length '{1}'.",
                ne.Count, ne.TotalLength);
        }
